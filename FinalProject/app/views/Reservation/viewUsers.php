...
<body style="background-color: #D6D6D6;">
    ...
    <a class="btn btn-light" href="<?= BASE ?>/Reservation/searchUser"><i class="fas fa-arrow-left p-r"></i> Back</a>
    ...
    if ($data != null) {
        ...
        foreach ($data as $user) {
            echo "<div class='list-group-item list-group-item-action flex-column align-items-start'>
                    <div class='d-flex w-100 justify-content-between'>
                        ...
                        <small><a href='" . BASE . "/Reservation/viewUserReservedBooks/$user->user_id'><i class='fas fa-book'></i></i></a></small>
                    </div>
                    <div class='d-flex w-100 justify-content-between'>
        ...
        echo "<section class='intro'>
                <div class='mask d-flex align-items-center mt-5 '>
                    <div class='container'>
                        <div class='row justify-content-center'>
                            <h1 class='container display-2 text-center'>User Not Found!!</h1>
                        </div>
                    </div>
                </div>
            </section>";
